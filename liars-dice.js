...
export default class LiarsDice {
    ...
    checkGameOver() {
        ...
        this.gameOver = (this.numPlayers == 1 || !this.user.active);
    }

    bidCheck() {
        /* Determines who lost and handles the outcomes */
    ...
    userMakeBid(number, face) {
        /* Allows the user to place a bid */
